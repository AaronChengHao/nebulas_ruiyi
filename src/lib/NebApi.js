function NebApi (){
    ...
    this.dappContactAddress = "n1mKH2fFFHNtjZj6YK9uqHwYZYgCcn82Lad";
    // console.log(window);
...
NebApi.prototype.set = function(srcs,time,address = '',extend = '',callback){
    ...
    var callArgs = `["${srcs}","${time}","${address}","${extend}"]`;
    var contract = {
        "function":callFunction,
        "args":  callArgs
    };

    window.serialNumber = this.nebPay.call(dappContactAddress, value, callFunction, callArgs, {    //使用nebpay的call接口去调用合约,
